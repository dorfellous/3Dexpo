  ...
  return (
    <group>
      <mesh position={[0, 0.12, 0]} receiveShadow>
        ...
        <meshStandardMaterial color="#070707" roughness={0.82} metalness={0.16} />
      </mesh>
...
function ProductLoadingIndicator() {
  ...
  const isProductLoading = active && String(item).includes('/products/')
  ...
  return (
    <div className="product-loading-indicator" aria-live="polite">
      <span className="loader__dot" />
